          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <div className="flex gap-3 mt-5">
                {settings?.socialLinks?.facebook && (
                  <a href={settings.socialLinks.facebook} target="_blank" rel="noopener noreferrer" className="h-9 w-9 rounded-lg bg-white/10 hover:bg-primary flex items-center justify-center transition-colors">
                ...
                {settings?.socialLinks?.twitter && (
                  <a href={settings.socialLinks.twitter} target="_blank" rel="noopener noreferrer" className="h-9 w-9 rounded-lg bg-white/10 hover:bg-primary flex items-center justify-center transition-colors">
                ...
                {settings?.socialLinks?.instagram && (
                  <a href={settings.socialLinks.instagram} target="_blank" rel="noopener noreferrer" className="h-9 w-9 rounded-lg bg-white/10 hover:bg-primary flex items-center justify-center transition-colors">
                ...
                {settings?.youtubeChannel && (
                  <a href={settings.youtubeChannel} target="_blank" rel="noopener noreferrer" className="h-9 w-9 rounded-lg bg-white/10 hover:bg-red-600 flex items-center justify-center transition-colors">
                ...
                {settings?.whatsappNumber && (
                  <a href={`https://wa.me/${settings.whatsappNumber.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer" className="h-9 w-9 rounded-lg bg-white/10 hover:bg-[#25D366] flex items-center justify-center transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><Link href="/refund" className="text-sm text-slate-400 hover:text-white transition-colors">Refund Policy</Link></li>
              </ul>
            </div>
